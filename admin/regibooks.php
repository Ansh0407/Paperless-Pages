          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="publiyear" class="form-control" placeholder="publishing year">
                </div> 
                <div class="form-group">
                          ...
                          if(mysqli_num_rows($query_run) > 0)
                          {
                              foreach($query_run as $row)
                              {
                                  ...
                                  <tr>
                                      ...
                                      <td><?php echo $row['publi_year']; ?> </td>
                                      <td><?php echo $row['prices']; ?> </td>
                                      <td><a href="borecode.php?bookid=<?php echo $row['bookid']; ?>" class="btn btn-info btn-sm">Edit</a></td>
