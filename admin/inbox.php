...
<head>
  ...
  <title>Paperless Pages | Mailbox</title>
    ...
    <!--ul class="navbar-nav ml-auto"-->
      ...
      <!--li class="nav-item dropdown">
        <a class="nav-link" data-toggle="dropdown" href="#">
          ...
          <!-- put no.of notifications inside below span-->
...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index.php" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Paperless Pages </span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="assets/dist/img/user9.jpg" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
          <a href="#" class="d-block">Ansh Bhandari</a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="registeredu.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Registered Users & Administrators</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="ebooks.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Details of Uploaded Books</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="usmem.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>User & Membership Details</p>
                </a>
              </li>
            </ul>
          </li>
          <li class="nav-header">Admininstrator Panel Widgets</li>
          <li class="nav-item">
              ...
              <div class="table-responsive mailbox-messages">
                <table class="table table-hover table-striped">
                      ...
                      if(mysqli_num_rows($query_run) > 0)
                          {
                              foreach($query_run as $row)
                              {
                                  ...
                                  <tr>
                                      ...
                                      <td class="mailbox-name"><a href="read-mail.html"><?php echo $row['username']; ?></a></td>
                                      <td class="mailbox-subject"><b><?php echo $row['reqno']; ?></b> - <?php echo $row['reqbook']; ?></td>
                  ...
                  <!--tr>
                    ...
                    <td class="mailbox-star"><a href="#"><i class="fas fa-star text-warning"></i></a></td>
                    <td class="mailbox-name"><a href="read-mail.html">Ansh Bhandari</a></td>
                    <td class="mailbox-subject"><b>Paperless Pages</b> - Fortis Fortuna Adiuvat
                    </td>
                  ...
                  <tr>
                    ...
                    <td class="mailbox-subject"><b>Paperless Pages</b> - Testing
                    </td>
                    <td class="mailbox-attachment"></td>
  ...
  <!--footer class="main-footer">
    ...
    <strong>Copyright &copy; 2022 <a href="">Paperless Pages</a>.</strong> All rights reserved.
  </footer-->
