...
<body>
    ...
    <div class = "bg">
        ...
        <div class="displaycuser" style="padding-left:20px;font-size: 25px;color:white;font-family:Montserrat;">
            ...
            <div class="navbar-links">
                <ul>
                    ...
                    <li><a href="http://localhost/eBook/browse.php" style = "font-size: 18px;">Browse</a></li>
                    <li><a href="http://localhost/eBook/dashboard.php" style = "font-size: 18px;">Dashboard</a></li>
        ...
        <div class="logoimg">
            <img src="./paperlesspages.png" style="position: relative;height: 225px; width: 550px;top: -6px;left: -20px;" id="logoimg" class="logoimg">
        </div>
                    ...
                    <?php
                        ...
                        if($result -> num_rows>0){
                            while($row=$result->fetch_assoc()){
                                echo "<tr><td>" . $row["bookid"]. "</td><td><a href='http://localhost/eBook/payment.php' style='text-decoration: none;color:darkgoldenrod;'>" . $row["title"]. "</a></td><td>" . $row["author"]. "</td><td>" . $row["genre"] ."</td><td>" . $row["rating"]. "</td><td>" . $row["isbn"]. "</td><td>" . $row["language"]. "</td><td>" . $row["publication_year"]. "</td><td>" . $row["prices"]. "</td></tr>";
                            }
                        }
