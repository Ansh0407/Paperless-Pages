...
<?php
    ...
    if(isset($_POST['submit'])){
        ...
        if($result -> num_rows == 1){
            ...
            $sql2 = "insert into curuser values('$uname','$pword')";
...
<body>
    ...
    <div class = "bg">
        ...
        <div class="navbar">  
            ...
            <div class="navbar-links">
                <ul>
                    ...
                    <!-- <li><a href="./signup.php" style = "font-size: 18px;">Login | SignUp</a></li> -->
                </ul>
            </div>
        </div>
        ...
        <form name="loginsignup" class="loginform" id="loginform" method="post" onsubmit="loginClick()">
            ...
            <div class="fusername">
                <input type="text" name="fusername" id="fusername" style="font-size: 23px;background-color: rgb(0 0 0 / 25%);color:antiquewhite;border: 0px;" placeholder="Enter your username" required>
            </div>
            
            <div class="fpassword">
                <input type="password" name = "fpassword" id="fpassword" style="font-size: 23px; background-color: rgb(0 0 0 / 25%);color:antiquewhite;border: 0px;" placeholder="Enter your password" required>
            </div>
        ...
        <div class="signupbox">
            <a href="./signup.php"><button type="button" id="signup" style="font-size: 17px;font-weight: bold;background-color: transparent;color: white;width: 125px;height: 41px;border: transparent;font-family:Nunito Sans;">Sign Up</button></a>
        </div>
